...
pipeline {
    ...
    stages {
        ...
        stage('Build') {
		    ...
		    docker image build --build-arg FLUENTD_IMG="${env.DOCKER_REPO}/stevengreenberginc/bfs/${FLUENTD_IMAGE_NAME}" -f docker-image/v1.10/oraclelinux-elasticsearch7/Dockerfile -t ${env.DOCKER_REPO}/${env.DOCKER_NAMESPACE}/${DOCKER_IMAGE_NAME} .
